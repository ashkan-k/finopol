...
@section('Content')
    <div class="main-header">
        <div class="inner">
            <div class="title">
                <h1><i class="fi fi-rs-edit"></i>ویرایش توکن</h1>
                ...
                <form action="{{ route('dashboard.tokens.update', $token) }}" method="post">
                    ...
                    <div class="row">
                                ...
                                <div class="select-group">
                                    <select name="user_id" class="select" required>
                                        @foreach($users as $user)
                                            ...
                                            $token->user_id)==$user->id)>{{ $user->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="input-group no-icon">
                                <label>توکن</label>
                                <input name="token" id="token_input" value="{{ old('token', $token->token) }}"
                                       class="input">
                                <div class="mt-1">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="input-group no-icon">
                                ...
                                <input type="hidden" name="activated_at" id="activated_at"
                                       value="{{ old('activated_at', optional($token->activated_at)->format('Y-m-d H:i:s')) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-actions" style="justify-content:flex-end; gap:10px;">
                        ...
                        <button class="btn btn-primary icon-right"><i class="fi fi-rs-check"></i>ثبت تغییرات</button>
                    </div>
                </form>
            </div>
        </div>
