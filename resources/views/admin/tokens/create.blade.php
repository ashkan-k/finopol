...
<div class="main-header">
    <div class="inner">
        <div class="title"><h1>ایجاد توکن</h1></div>
    </div>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="input-group no-icon">
                            ...
                            <input name="ips" value="{{ old('ips') }}" class="input" placeholder="مثال: 1.1.1.1، 2.2.2.2">
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="input-group no-icon">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="input-group no-icon">
                            ...
                            <input type="hidden" name="activated_at" id="activated_at" value="{{ old('activated_at') }}">
                        </div>
                    </div>
                </div>
