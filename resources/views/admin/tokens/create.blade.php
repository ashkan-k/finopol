...
@section('Content')
    <div class="main-header">
        <div class="inner">
            <div class="title">
                <h1><i class="fi fi-rs-add"></i>ایجاد توکن</h1>
                <div class="breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb-list mb-0">
                            <li class="breadcrumb-item"><a href="/dashboard">داشبورد</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.tokens.index') }}">توکن‌ها</a></li>
    ...
    <div class="main-inner">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('dashboard.tokens.store') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            ...
                            @error('token')<div class="text-alert error">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="input-group no-icon">
                                <label>کاربر</label>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="input-group no-icon">
                                ...
                                <input name="ips" value="{{ old('ips') }}" class="input"
                                       placeholder="مثال: 1.1.1.1، 2.2.2.2">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="input-group no-icon">
                                <label>توکن</label>
                                <input name="token" id="token_input" value="{{ old('token') }}" class="input">
                                <div class="mt-1">
                                    <label style="display:inline-flex; align-items:center; gap:6px;">
                                        <input type="checkbox" name="auto_generate_token" id="auto_generate_token"
                                               value="1" {{ old('auto_generate_token') ? 'checked' : '' }}>
                                        ساخت خودکار توکن
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="input-group no-icon">
                                ...
                                <input type="text" id="activated_at_display" class="input"
                                       placeholder="انتخاب تاریخ و زمان">
                                <input type="hidden" name="activated_at" id="activated_at"
                    ...
                    <div class="form-actions" style="justify-content:flex-end; gap:10px;">
                        <a href="{{ route('dashboard.tokens.index') }}" class="btn btn-primary-outline icon-right"><i
                                class="fi fi-rs-cross"></i>انصراف</a>
                        <button class="btn btn-primary icon-right"><i class="fi fi-rs-check"></i>ثبت</button>
                    </div>
                </form>
            </div>
        </div>
