...
@section('Content')
    <div class="main-header">
        <div class="inner">
            <div class="title"><h1><i class="fi fi-rs-add"></i>ایجاد سرویس</h1></div>
        </div>
    </div>
    <div class="main-inner">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('dashboard.finoservices.store') }}">
                    @csrf
                    <div class="row">
                         <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="input-group no-icon">
                                <label>قیمت</label>
                                <input class="input" name="price" value="{{ old('price') }}"/>
                        ...
                        <div class="col-lg-6">
                            <div class="input-group no-icon">
                                ...
                                <input class="input" name="respond_min_answer_time"
                                       value="{{ old('respond_min_answer_time') }}"/>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="input-group no-icon">
                                ...
                                <input class="input" name="icon_svg" value="{{ old('icon_svg') }}"/>
                        ...
                        <div class="col-lg-6">
                            <div class="input-group no-icon">
                                ...
                                <input class="input" name="api_link" value="{{ old('api_link') }}"/>
                    ...
                    <div class="input-group no-icon">
                        <label>توضیحات</label>
                        <textarea class="input" rows="5" name="description">{{ old('description') }}</textarea>
                         @error('description')<div style="color:#d22c2c; font-size:12px; margin-top:4px;">{{ $message }}</div>@enderror
                    </div>
                    <div class="input-group no-icon">
                        <label>جیسون swagger api</label>
                        <textarea class="input" rows="8" name="api_guide_json">{{ old('api_guide_json') }}</textarea>
                         @error('api_guide_json')<div style="color:#d22c2c; font-size:12px; margin-top:4px;">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-actions">
                        <a href="{{ route('dashboard.finoservices.index') }}"
                           class="btn btn-primary-outline icon-right"><i
