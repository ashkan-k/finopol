...
@section('Content')
    <div class="main-header">
        <div class="inner">
            <div class="title">
                <h1><i class="fi fi-rs-add"></i>ایجاد کاربر</h1>
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('dashboard.users.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                 <div class="input-group no-icon"><label>رمز عبور</label><input type="password"
                                                                                                name="password"
                                                                                                class="input" required>@error('password')<div class="text-alert error">{{ $message }}</div>@enderror
                                 </div>
                            </div>
                        </div>
